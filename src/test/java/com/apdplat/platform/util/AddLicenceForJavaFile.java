...
public class AddLicenceForJavaFile {
    ...
    private static List<String> wrong = new ArrayList<String>();
    ...
    public static void main(String[] args) {
        ...
        addLicenceForJavaFile(new File("D:\\jobs\\workspace\\unique-web\\src\\main\\java"), licence);
        //addLicenceForJavaFile(new File("F:\\exemple"), licence);
